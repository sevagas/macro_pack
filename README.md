...
Obfuscation feature is compatible with all VBA of VBS based format which can be generated by macri\_pack.  
...
Note that all scripting and shortbuts formats can be generated on Linux version of macro\_pack as well.
