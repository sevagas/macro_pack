...
def main(argv):   
    ...
    try:
        longOptions = ["embed=", "listen=", "Wlisten=", "generate=", "quiet", "input-file=", "encode","obfuscate","obfuscate-form", "obfuscate-names", "obfuscate-strings", "file=","template=", "start-function=","unicode-rtlo=", "dde", "print"] 
